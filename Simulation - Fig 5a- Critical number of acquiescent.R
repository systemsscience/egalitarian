...
startingfractionHawkDefect <- 0.95
...
startingfractionAcquiescent <- seq(0,1,by=0.01)
...
totalruns <- length(startingfractionAcquiescent) * repetitions
...
for (i in 1:length(startingfractionAcquiescent)) {
	...
	for(repetition in 1:repetitions) {	
		...
		Frequencies[wh] <- (1-startingfractionHawkDefect) / length(wh)
...
temporarytable <- data.frame(rval,dval,cval,wval,bval,sacq,FractionDove, FractionCooperator,FractionLeveller,FractionConditionalCooperator,FractionConditionalDove, FractionComplyToLeveller,FractionComplyToConditionalCooperator,FractionComplyToConditionalDove)
...
points(result$sacq, result$FractionCooperator,type="l",col="darkorange",lwd=3)
points(result$sacq, result$FractionConditionalCooperator, type="l",col="darkorange",lty=1)
points(result$sacq, result$FractionComplyToConditionalCooperator, type="l",lty=3,lwd=1,col="darkorange")
points(result$sacq, result$FractionLeveller, type="l",col="green4",lwd=4,lty=1)
points(result$sacq, result$FractionComplyToLeveller, type="l",lty=3,lwd=1,col="green4")
axis(2,at=c(0,1))
axis(1,at=c(0,1))
